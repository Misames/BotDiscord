...
let rules = readFileSync('./src/rules.md', 'utf8')
let synthaxe = readFileSync('./src/synthaxe.md', 'utf8')
let help = readFileSync('./src/help.md', 'utf8')
...
Client.on('message', ({ author, content, guild }) => {
    if (author.lastMessage.content.startsWith('!ModifyRules') && author.id === guild.ownerID) {
        ...
        writeFile('./src/rules.md', (rules = content.split('!ModifyRules')), (err) =>
